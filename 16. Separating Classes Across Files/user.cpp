...
int User::get_user_count() // Remove static keyword in this file
{
    return user_count;
}
...
void output_status(User user) // Friend method is defined here (Allows access to private variables without polluting the class with public methods). REMOVE THE FRIEND KEYWORD IN THIS FILE
{
